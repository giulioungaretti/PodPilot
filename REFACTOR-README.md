...
Follow the step-by-step instructions in [`docs/REFACTOR-Move-CLI-Services.md`](docs/REFACTOR-Move-CLI-Services.md)
...
- **Full Analysis:** [`docs/CLI-Exclusive-Components-Implementation.md`](docs/CLI-Exclusive-Components-Implementation.md)
- **Manual Steps:** [`docs/REFACTOR-Move-CLI-Services.md`](docs/REFACTOR-Move-CLI-Services.md)
